...
namespace NationalParks.APIHandlerManager
{
  public class APIHandler
  {
        ...
        // https://api.open.fec.gov/developers/#/financial/get_elections_

        static string BASE_URL = "https://developer.nrel.gov/api/alt-fuel-stations/v1/";
    static string API_KEY = "IVIJc5t2ZelclyWVyDEIU5xW3g6nnRvV6SWaq0F8"; //Add your API key here inside ""
    ...
    {
      string NATIONAL_PARK_API_PATH = BASE_URL + "/elections/";
      string parksData = "";
